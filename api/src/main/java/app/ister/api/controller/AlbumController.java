...
public class AlbumController {
    ...
    @SchemaMapping(typeName = "Album", field = "images")
    public List<ImageEntity> images(AlbumEntity albumEntity) {
        return imageRepository.findByAlbumEntityId(albumEntity.getId());
    }
}
