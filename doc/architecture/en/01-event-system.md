...
| `HandleSubtitleExtractRequested` | disk | `SUBTITLE_EXTRACT_REQUESTED` | — (extracts one text subtitle stream to an SRT in the owner's cache directory, uploading it when run on a helper; helper-capable) |
