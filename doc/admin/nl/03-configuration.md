...
| mkvextract | `MKVEXTRACT` | `/usr/bin/mkvextract` | pakt dvd-ondertiteltracks (VobSub) uit voor de sprite-sheets van bitmap-ondertitels; blu-ray (PGS) heeft alleen FFmpeg nodig |
