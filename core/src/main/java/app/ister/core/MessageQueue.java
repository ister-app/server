...
public class MessageQueue {
    ...
    public static final String APP_ISTER_SERVER_DETECT_SEGMENTS = "app.ister.server.DetectSegments";
    public static final String APP_ISTER_SERVER_SUBTITLE_EXTRACT_REQUESTED = "app.ister.server.SubtitleExtractRequested";
