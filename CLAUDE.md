...
- `DETECT_SEGMENTS`, `SUBTITLE_EXTRACT_REQUESTED` — intro/outro detection per season and embedded-subtitle extraction/OCR per stream; both split out of `MEDIA_FILE_FOUND` (published after commit) because they run for minutes
